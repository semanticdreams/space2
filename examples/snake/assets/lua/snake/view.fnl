...
(fn layout-screen [layout game background title board status controls]
  ...
  (local title-y base-y)
  (local board-y (+ title-y title-size.y screen-gap))
  (local status-y (+ board-y board-size.y screen-gap))
  (local controls-y (+ status-y status-size.y screen-gap))
